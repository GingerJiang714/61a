...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if player==0:
            thisround = take_turn(strategy0(score0,score1), score1, dice)
            score0+=thisround
        else:
            thisround = take_turn(strategy1(score1,score0), score0,dice)
            score1+=thisround
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            ...
            currentscore = score1
        if currentscore - previous_score > previous_high:
            diff = currentscore - previous_score
            if diff ==1:
                pointwriting = "point!"
            else:
                pointwriting = "points!"
        ...
        if pointwriting:
            print(diff, pointwriting,"That's the biggest gain yet for Player",who)

        return announce_highest(who, diff, currentscore)
    return say
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    curr = 1
    while curr<=10:
        score = make_averaged(roll_dice)(curr,dice)
        if score>maxscore:
            minroll = curr
            maxscore = score
        curr+=1
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 10
    #print(free_bacon(opponent_score))
